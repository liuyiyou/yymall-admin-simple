...
import cn.liuyiyou.yiadmin.entity.SysDictType;
import cn.liuyiyou.yiadmin.result.Response;
import cn.liuyiyou.yiadmin.result.Result;
import cn.liuyiyou.yiadmin.service.ISysDictTypeService;
...
//    @RequiresPermissions("system:dict:list")
    ...
    public Result<IPage<SysDictType>> list(@RequestBody DataTableVo dataTableVo) {
        Page<SysDictType> pageQuery = new Page<>(dataTableVo.getPageNum(), dataTableVo.getPageSize());
