...
$(function () {
    ...
    // 初始bootstrap table数据
    // 初始bootstrap table数据
    $.initJsonTable = function (_columns, _url) {
    ...
    $.initTableJsonParams = function (_columns, _url, _queryParams) {
        $('.bootstrap-table').bootstrapTable({
            method: 'post',                // 请求方式（*）
            dataType: "json",             // 返回格式（*）
            url: _url,                    // 请求后台的URL（*）
    ...
    // 获取选中复选框项，返回 1,2
    $.getCheckedsArray = function (_name) {
